...
RSpec.describe SponsoredPostsController, type: :controller do
    ...
    it "increases the number of SponsoredPost by 1" do
      expect{
        post :create, params: {
          ...
          sponsored_post: { title: RandomData.random_sentence, body: RandomData.random_paragraph, price: RandomData.random_number}
        }
  ...
  describe "PUT update" do
    it "updates sponsored post with expect attributes" do
      ...
      expect(updated_sponsored_post.price).to eq new_price.to_i
    end
